...
export default function Footer() {
  return (
    <div
      style={{ padding: "4rem 6rem", justifyContent: "start" }}
    ...
    >
      <div className="CenterColumn">
        ...
        <div className="RowContainer">
          ...
          ></input>
          <button className="LeftHeaderButton">Subscribe</button>
        </div>
      </div>
      <div
      ...
      >
        <div className="Column">
          <h1 style={{ fontSize: "2.5rem" }} className="h1_footer">
            Contact Us
          </h1>
        ...
        <div style={{ justifyContent: "center" }} className="Column">
          <div>
            <img className="GerImgDiv" src={GerichtImage} />
          </div>
        ...
        <div className="Column">
          ...
          <p style={{ margin: "0", fontSize: "1.5rem" }} className="p_opensans">
            Monday-Friday:
          </p>
